...
- `create_ext4_rootfs`: 创建测试 ext4 rootfs，并打入测试脚本、模块目录和用户态触发程序
- `create_initramfs`: 创建测试 initramfs（兼容路径）
...
### 工具步骤
<逐项列出 check_qemu_available / create_ext4_rootfs 或 create_initramfs / boot_kernel / analyze_boot_log 的 status、message、artifact>
