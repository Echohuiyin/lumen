...
| Tool Experts | 采集 crash、锁、日志或历史案例证据 | `expert_results` |
| Kernel Expert | 汇总证据、构造复现器、输出内核与 UAF contract | `kernel_contract` |
| Test Expert | 只执行已校验 contract 对应的 QEMU 计划 | `test_contract` |
